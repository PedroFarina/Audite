...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/AudioKit/AudioKit.xcframework" "" "false" "ios-arm64_i386_x86_64-simulator/AudioKit.framework" "ios-x86_64-maccatalyst/AudioKit.framework" "ios-arm64_armv7/AudioKit.framework"
fi
